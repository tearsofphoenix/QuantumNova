...
extern const QN_STRONG QCArrayRef QCInt32ArrayCreate(const void *initData, size_t count, bool needCopy);

extern QN_STRONG QCArrayRef QCInt32ArrayFromFile(FILE *fp);
