...
extern QN_STRONG QCArrayRef QCByteArrayFromFile(FILE *fp);

/*
 * create byte array from hex string
 */
extern QN_STRONG QCArrayRef QCByteArrayCreateWithHex(const char *hexString, size_t length);

/*
 * create byte array from base64 encoded string
 */
extern QN_STRONG QCArrayRef QCByteArrayCreateWithBase64(const char *base64String, size_t length);

/*
 * do pkcs7 encode on array
 */
extern QN_STRONG QCArrayRef QCByteArrayPKCS7Encode(QCArrayRef array);

/*
 * do pcks7 decode on array
 */
extern QN_STRONG QCArrayRef QCByteArrayPKCS7Decode(QCArrayRef array);
